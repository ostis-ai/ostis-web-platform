...
This repository is a web-oriented software platform of the [ostis-platform](https://github.com/ostis-ai) and is intended to be a solid framework to help you deploy existing and create new ostis-systems.
